...
export function rpsls(shot2) {
  ...
  if (!choicesRPSLS.includes(shot)){
    throw new Error(`${shot2} is out of range`);
    
   // process.exit(1);
  } 
  shot2=shot2.toLowerCase();
  let result2; 
 if (shot2 === opponent2) {
    result = "tie";
  } 
  else if ((shot2 === "rock" && (opponent2 === "scissors" || opponent2 === "lizard")) ||
    (shot2 === "paper" && (opponent2 === "rock" || opponent2 === "spock")) ||
    (shot2 === "scissors" && (opponent2 === "paper" || opponent2 === "lizard")))
    {
    result = "win";
      return { 'player': shot2, 'opponent': opponent2, 'result': result2 };
